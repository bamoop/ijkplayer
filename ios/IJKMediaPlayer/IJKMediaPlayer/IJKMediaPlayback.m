...
NSString *const IJKMoviePlayerRTSPPaddingNotification = @"IJKMoviePlayerRTSPPaddingNotification";

NSString *const IJKMoviePlayerVideoSizeChangedNotification = @"IJKMoviePlayerVideoSizeChangedNotification";
